...
void vertical_blur3_avx512_8(void* __restrict dstp_, const void* srcp_, int dst_pitch, int src_pitch, int width, int height) noexcept
{
    ...
    const int mod64_width = (width + 63) & ~63;
...
{
    vertical_blur3_avx512_16(tempp_, srcp_, temp_pitch, src_pitch, width, height); //temp = rg11
    mt_makediff_avx512_16<u>(dstp_, srcp_, tempp_, dst_pitch, src_pitch, temp_pitch, width, height); //dst = rg11D
    vertical_blur3_avx512_16(tempp_, dstp_, temp_pitch, dst_pitch, width, height); //temp = rg11D.vblur()
...
template void vertical_sbr_avx512_16<512, 0x200200>(void* __restrict dstp, void* __restrict tempp, const void* srcp, int dst_pitch, int temp_pitch, int src_pitch, int width, int height) noexcept;
template void vertical_sbr_avx512_16<2048, 0x800800>(void* __restrict dstp, void* __restrict tempp, const void* srcp, int dst_pitch, int temp_pitch, int src_pitch, int width, int height) noexcept;
template void vertical_sbr_avx512_16<8192, 0x20002000>(void* __restrict dstp, void* __restrict tempp, const void* srcp, int dst_pitch, int temp_pitch, int src_pitch, int width, int height) noexcept;
template void vertical_sbr_avx512_16<32768, 0x80008000>(void* __restrict dstp, void* __restrict tempp, const void* srcp, int dst_pitch, int temp_pitch, int src_pitch, int width, int height) noexcept;
